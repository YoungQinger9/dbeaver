...
public class YashanDBSchema extends OracleSchema {
	...
	final private YashanDBTableCache yashanDBTableCache = new YashanDBTableCache();
	final private YashanDBForeignKeyCache yashanDBForeignKeyCache = new YashanDBForeignKeyCache();
	final private YashanDBConstraintCache yashanDBConstraintCache = new YashanDBConstraintCache();
	final private YashanDBIndexCache yashanDBIndexCache = new YashanDBIndexCache();
	final private YashanDBTableTriggerCache YashanDBTableTriggerCache = new YashanDBTableTriggerCache();
	final private YashanDBDataTypeCache yashanDBDataTypeCache = new YashanDBDataTypeCache();
	final private YashanDBPackageCache yashanDBPackageCache = new YashanDBPackageCache();
	final private YashanDBProceduresCache yashanDBProceduresCache = new YashanDBProceduresCache();
	final private YashanDBSchedulerJobCache yashanDBSchedulerJobCache = new YashanDBSchedulerJobCache();
	...
	class YashanDBIndexCache extends IndexCache {
		...
		protected OracleTableIndexColumn[] fetchObjectRow(@NotNull JDBCSession session, @NotNull OracleTableBase parent,
				@NotNull OracleTableIndex object, @NotNull JDBCResultSet dbResult) throws DBException {
	...
	class YashanDBTableTriggerCache extends TableTriggerCache {
		...
		protected YashanDBTableTrigger fetchObject(@NotNull JDBCSession session, @NotNull OracleSchema schema,
				@NotNull OracleTableBase table, @NotNull String childName, @NotNull JDBCResultSet resultSet)
				throws SQLException, DBException {
			return new YashanDBTableTrigger(table, resultSet);
		}
	}

	class YashanDBDataTypeCache extends DataTypeCache {
	...
	class YashanDBPackageCache extends PackageCache {
	...
	class YashanDBProceduresCache extends ProceduresCache {

		@NotNull
		@Override
		public JDBCStatement prepareLookupStatement(@NotNull JDBCSession session, @NotNull OracleSchema owner,
				@Nullable OracleProcedureStandalone object, @Nullable String objectName) throws SQLException {
	...
	class YashanDBSchedulerJobCache extends SchedulerJobCache {
